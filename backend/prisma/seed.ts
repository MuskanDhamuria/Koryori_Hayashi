...
const menuSeed = [
  {
    ...
    imageUrl: "/images/menu/japanese_oyster.png",
    price: 3.8,
    cost: 1.6,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/cream_croquette.png",
    price: 4.8,
    cost: 1.9,
    categorySlug: "appetizers",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/fried_oyster.png",
    price: 3.8,
    cost: 1.5,
    categorySlug: "appetizers",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/geso_karage.png",
    price: 4.8,
    cost: 2.0,
    categorySlug: "appetizers",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/aji_fry.png",
    price: 3.8,
    cost: 1.4,
    categorySlug: "appetizers",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/king_prawn.png",
    price: 7.8,
    cost: 3.2,
    categorySlug: "appetizers",
    isHighMargin: false,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/mentaiko_pasta.png",
    price: 9.8,
    cost: 3.4,
    categorySlug: "mains",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/mushroom_pasta.png",
    price: 9.8,
    cost: 3.8,
    categorySlug: "mains",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/katsu_don.png",
    price: 8.8,
    cost: 3.1,
    categorySlug: "mains",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/chicken_nanban_don.png",
    price: 8.8,
    cost: 3.0,
    categorySlug: "mains",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/salmon-teriyaki-don.PNG",
    price: 9.8,
    cost: 4.2,
    categorySlug: "mains",
    isHighMargin: false,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/kitsune_udon.png",
    price: 7.8,
    cost: 2.9,
    categorySlug: "ramen",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/sukiyaki_beef_udon.png",
    price: 9.8,
    cost: 4.0,
    categorySlug: "ramen",
    isHighMargin: false,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/tempura_udon.png",
    price: 11.8,
    cost: 4.6,
    categorySlug: "ramen",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/jersey_milk_ice_cream.png",
    price: 2.5,
    cost: 0.8,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/monaka_shell_ice_cream.png",
    price: 3.0,
    cost: 1.0,
    categorySlug: "desserts",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/tempura_ice_cream.png",
    price: 4.8,
    cost: 1.7,
    categorySlug: "desserts",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/spicy_karage.png",
    price: 10.99,
    cost: 4.1,
    categorySlug: "appetizers",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/matcha_cheesecake.png",
    price: 7.99,
    cost: 2.5,
    categorySlug: "desserts",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/yuzu_sparkling_soda.png",
    price: 4.99,
    cost: 1.1,
    categorySlug: "drinks",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/ice_lemon_tea.png",
    price: 3.5,
    cost: 0.9,
    categorySlug: "drinks",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/thai_milk_tea.png",
    price: 4.5,
    cost: 1.2,
    categorySlug: "drinks",
    isHighMargin: true,
  ...
  },
  {
    ...
    imageUrl: "/images/menu/watermelon_juice.png",
    price: 5.5,
    cost: 1.8,
    categorySlug: "drinks",
    isHighMargin: false,
